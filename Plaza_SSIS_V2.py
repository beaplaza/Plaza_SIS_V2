...
class Home(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="STUDENT INFORMATION SYSTEM", font=("Courier New",40,"bold"))
        label.place(x=250,y=20)

        home = tk.Button(self, text="HOME",font=("Courier New",18,"bold"),bd=0, width = 20, bg="Yellow", fg="Blue", command=lambda: controller.show(Home))
        home.place(x=568,y=300)
        home.config(cursor= "hand2")
        
        course = tk.Button(self, text="COURSES",font=("Courier New",18,"bold"),bd=0, width = 20, bg="Blue", fg="Yellow", command=lambda: controller.show(Courses))
        course.place(x=568,y=350)
        course.config(cursor= "hand2")
        
        students = tk.Button(self, text="REGISTRATION",font=("Courier New",18,"bold"),bd=0, width = 20, bg="Blue", fg="Yellow", command=lambda: controller.show(Students))
        students.place(x=568,y=400)
        students.config(cursor= "hand2")

        students = tk.Button(self, text="EXIT",font=("Courier New",16,"bold"),bd=0, width = 10, bg="Red", fg="Black", command=iExit)
        students.place(x=1000,y=460)
        students.config(cursor= "hand2")
...
class Courses(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="COURSES", font=("Courier New",40,"bold"))
        ...
        home = tk.Button(self, text="HOME",font=("Courier New",13,"bold"),bd=0, width = 10, bg="Blue", fg="Yellow", command=lambda: controller.show(Home))
        home.place(x=1000,y=600)
        home.config(cursor= "hand2")
        
        

        
        self.lblccode = Label(self, font=("Courier New", 12, "bold"), text="Course Code:", padx=5, pady=5)
        self.lblccode.place(x=125,y=144)
        self.txtccode = Entry(self, font=("Courier New", 13), textvariable=Course_Code, width=31)
        self.txtccode.place(x=250,y=150)

        self.lblcname = Label(self, font=("Courier New", 12,"bold"), text="Course Name:", padx=5, pady=5)
        self.lblcname.place(x=125,y=205)
        self.txtcname = Entry(self, font=("Courier New", 13), textvariable=Course_Name, width=31)
        self.txtcname.place(x=250,y=210)
        
        self.SearchBar = Entry(self, font=("Courier New", 11), textvariable=SearchBar_Var, bd=0,bg="White",width=31)
        self.SearchBar.place(x=650,y=105)
        ...
        self.adds = Button(self, text="ADD", font=('Courier New', 11, ), height=1, width=10, bd=1, bg="Yellow", fg="Blue",command=add_course)
        self.adds.place(x=300,y=300)
        self.adds.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Courier New', 11), height=1, width=10, bd=1, bg="Yellow", fg="Blue", command=update_course) 
        self.update.place(x=300,y=360)
        self.update.config(cursor= "hand2")

        self.clear = Button(self, text="CLEAR", font=('Courier New', 11), height=1, width=10, bd=1, bg="Red", fg="Blue", command=clear)
        self.clear.place(x=300,y=420)
        self.clear.config(cursor= "hand2")

        self.delete = Button(self, text="DELETE", font=('Courier New', 11), height=1, width=10, bd=1, bg="Red", fg="Blue", command=delete_course)
        self.delete.place(x=300,y=480)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Courier New', 11, 'bold'),bd=0, bg= "Yellow", fg="Blue", command=search_course)
        self.search.place(x=575,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Courier New', 11, 'bold'), height=1, width=11, bg="Blue", fg="Yellow", command=display_course)
        self.display.place(x=575,y=550)
...
class Students(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="REGISTRATION FORM ", font=("Courier New",40,"bold"))
        label.place(x=450,y=20)
        
        home = tk.Button(self, text="HOME",font=("Courier New",12,"bold"),bd=0, width = 7, bg="Blue", fg="Yellow",  command=lambda: controller.show(Home))
        home.place(x=1000,y=600)
        home.config(cursor= "hand2")
        ...
        self.lblid = Label(self, font=("Courier New", 12,"bold"), text="ID Number:", padx=5, pady=5)
        self.lblid.place(x=125,y=144)
        self.txtid = Entry(self, font=("Courier New", 13), textvariable=Student_ID, width=33)
        self.txtid.place(x=230,y=150)

        self.lblname = Label(self, font=("Courier New", 12,"bold"), text="Name:", padx=5, pady=5)
        self.lblname.place(x=125,y=205)
        self.txtname = Entry(self, font=("Courier New", 13), textvariable=Student_Name, width=33)
        self.txtname.place(x=230,y=210)
        
        self.lblc = Label(self, font=("Courier New", 12,"bold"), text="Course Code:", padx=5, pady=5)
        self.lblc.place(x=125,y=269)
        self.txtyear = ttk.Combobox(self, value=["BS Stat", "BS Math", "BS IT", "BSCS","BSA","BS Bio","BS Chem","BSCE","BSHM","BS Micro","BSN","BA Philo","BA PolSci"], state="readonly", font=("Lucida Console", 12), textvariable=Course_Code, width=28)
        self.txtyear.place(x=255,y=274)
        

        self.lblyear = Label(self, font=("Courier New", 12,"bold"), text="Year Level:", padx=5, pady=5)
        ...
        self.lblgender = Label(self, font=("Courier New", 13,"bold"), text="Gender:", padx=5, pady=5)
        self.lblgender.place(x=125,y=361)
        self.txtgender = ttk.Combobox(self, value=["Male", "Female"], font=("Courier New", 13), state="readonly", textvariable=Student_Gender, width=28)
        ...
        self.add = Button(self, text="REGISTER", font=('Courier New', 11), height=1, width=10, bd=1,  bg="Blue", fg="Yellow", command=add_stud)
        self.add.place(x=150,y=420)
        self.add.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Courier New', 11), height=1, width=10, bd=1, bg="Blue", fg="Yellow", command=update_stud)
        ...
        self.delete = Button(self, text="DELETE", font=('Courier New', 11), height=1, width=10, bd=1, bg="Red", fg="Blue", command=delete_stud)
        self.delete.place(x=450,y=420)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Courier New', 11, 'bold'),bd=0, bg= 'Blue', fg="Yellow", command=search_stud)
        self.search.place(x=575,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Courier New', 11, 'bold'), height=1, width=11,  bg="Blue", fg="Yellow",command = display_stud)
        self.display.place(x=575,y=550)
        self.display.config(cursor= "hand2")
