...
class Home(tk.Frame):
    def __init__(self, parent, controller):
        ...
        students.place(x=550,y=400)
        students.config(cursor= "hand2")

        students = tk.Button(self, text="EXIT",font=("Courier New",18,"bold"),bd=0, width = 20, bg="Red", fg="Black", command=iExit)
        students.place(x=550,y=450)
        students.config(cursor= "hand2")
